...
import com.plugin.demo.language.psi.CURLCommand;
...
public class CURLInlayHintCollector extends FactoryInlayHintsCollector {
    ...
    // collect 方法用于收集每个 PSI 元素的内嵌提示信息
    @Override
    ...
    private void addHint(Editor editor, PsiElement element, InlayHintsSink sink) {
        ...
        sink.addBlockElement(line, true, blockText, new BlockConstraints(false, 0, 0, 0));
